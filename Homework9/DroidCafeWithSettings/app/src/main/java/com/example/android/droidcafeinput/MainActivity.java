...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // To do
        PreferenceManager theManager = new PreferenceManager(this);
        SharedPreferences mPreferences = theManager.getSharedPreferences();
        String countryString = mPreferences.getString("market_addr",null);
        displayToast(countryString);
        // To do end
    }
